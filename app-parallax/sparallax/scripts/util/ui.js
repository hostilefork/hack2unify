...
function showLightboxForThumbnail(evt, url) {
    ...
    //var q = href.indexOf("?");
    href = href.substr(0, href.length) ;
    
    pictureDiv.innerHTML = '<img src="' + href + '" width=\"300\" height=\"300\";style="margin-top: 50px; padding: 10px; border: 1px solid #aaa;" />';
