...
TopicPageRendering.prototype._render = function(o) {
    ...
    outerDiv.innerHTML = '<h1>' + o.name + ' <a class="topic-view-freebase-link" href="' +  itemID + '">view on '+config.dataset+'</a></h1><table cellspacing="0" cellpadding="0"><tr valign="top"><td></td><td width="30%"></td></tr></table>';
