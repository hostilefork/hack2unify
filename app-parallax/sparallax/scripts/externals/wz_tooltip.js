...
Appearance & behaviour of tooltips can be individually config1ured
...
config1. BgColor			= '#E2E7FF'	// Background colour (HTML colour value, in quotes)
config1. BgImg			= ''		// Path to background image, none if empty string ''
config1. BorderColor		= '#003099'
...
config1. Height			= 0			// Tooltip height; 0 for automatic adaption to tooltip content, < 0 (e.g. -100) for a maximum for automatic adaption
config1. JumpHorz		= false		// false or true - jump horizontally to other side of mouse if tooltip would extend past clientarea boundary
...
config1. TitleFontColor	= '#FFFFFF'	// Color of title text - if '', BgColor (of tooltip body) will be used
config1. TitleFontFace	= ''		// If '' use FontFace (boldified)
config1. TitleFontSize	= ''		// If '' use FontSize
config1. TitlePadding	= 2
...
//=======  END OF TOOLTIP config1, DO NOT CHANGE ANYTHING BELOW  ==============//
...
// OnLoadconfig1, OnCreateContentString, OnSubDivsCreated, OnShow, OnMoveBefore,
// OnMoveAfter, OnHideInit, OnHide, OnKill

var tt_aElt = new Array(10), // Container DIV, outer title & body DIVs, inner title & body TDs, closebutton SPAN, shadow DIVs, and IFRAME to cover windowed elements in IE
tt_aV = new Array(),	// Caches and enumerates config1 data for currently active tooltip
...
function tt_Init()
{
	...
	// the user if they've forgotten to set the TagsToTip config1 flag
...
function tt_Adaptconfig11()
{
	tt_ExtCallFncs(0, "Loadconfig1");
